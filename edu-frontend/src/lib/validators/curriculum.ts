 ...
 * task40：契约② /api/series 用 category（dim_course_category 一级分类），无 level 筛选 */
export const CourseSearchSchema = z.object({
  q: z.string().max(64, "关键词最多 64 个字符").optional(),
  category: z
    .enum(["all", "computer_science", "mathematics", "exam_prep", "management", "enterprise_training", "campus_growth"], {
      message: "分类值无效",
    })
    .optional()
    .default("all"),
