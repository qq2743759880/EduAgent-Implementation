 ...
 * 糖果版块色（candy-playful frozen，task51 社区页对齐 approved HTML）：实底糖果 pill + 白字，
 *   英语=蓝 / 数学=紫 / 编程=绿 / 综合=橙；PostCard 与筛选 chips 复用，灰度无渐变。
 * PostEditor 仅用 label；gradientClass 置空（禁自造渐变）。
 */
export const BOARDS: BoardMeta[] = [
  { code: "english", label: "英语", colorClass: "bg-candy-blue text-white", gradientClass: "" },
  { code: "math", label: "数学", colorClass: "bg-candy-purple text-white", gradientClass: "" },
  { code: "programming", label: "编程", colorClass: "bg-candy-green text-white", gradientClass: "" },
  { code: "general", label: "综合", colorClass: "bg-candy-orange text-white", gradientClass: "" },
];
