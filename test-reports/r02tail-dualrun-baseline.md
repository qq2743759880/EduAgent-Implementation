...
- ran_at: 2026-09-15T10:16:38  |  git_rev: `509496d`  |  seed: 20260914
...
- **docs Jaccard**: mean=0.85, p50=1.0, p95=1.0, min=0.0, max=1.0（五条件参考 mean>0.9；=1 共 82 条，<0.5 共 18 条，=0 共 11 条）
...
|---|---|---|---|---|---|
| 旧 run_agent_turn | 100 | 2.299 | 3.085 | 1.19 | 27.967 |
| 新 run_agent(图) | 100 | 2.718 | 3.983 | 1.395 | 45.637 |

- P95 容差对照（五条件参考：新 ≤ 旧 P95 × 1.1）: 旧 3.085s vs 新 3.983s
...
| intent分歧<5% | {"当前值": "0.0%"} |
| docsJaccard>0.9 | {"当前值": 0.85} |
| P95TTFT容差 | {"旧P95_s": 3.085, "新P95_s": 3.983, "阈值说明": "旧路径实测 P95 + 10%；阈值裁定属用户/编排者，本探针只报数"} |
