...
2. **前任 commit message 数字失真**：0d20a2d 声称「eval64 0.0312→0.0781」，但其默认配置 v2a_0.30 实测仅 0.0625——0.0781 属 probe 网格里 v2c 变体。**接手者若不复跑 probe 即采信，会带着错误数字定稿**（回执数字仅作线索铁律第 N 次生效）。
